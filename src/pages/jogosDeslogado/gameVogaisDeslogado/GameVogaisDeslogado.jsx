...
import CompLetras from '@/components/jogoVogais/letras/Letras';
import { SortableContext, rectSortingStrategy } from '@dnd-kit/sortable';

import styles from './gameVogaisDeslogado.module.css';

function GameVogaisDeslogado({ letters }) {
...
export default GameVogaisDeslogado;