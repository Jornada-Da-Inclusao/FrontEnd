 ...
 * @param {import("@/models/UsuarioLogin.js").UsuarioLogin} Resposta retornada pela API
 */
 ...
 */
export async function cadastrarUsuario(url, dados, setDados) {
 ...
 */
export async function login(url, dados, setDados) {
 ...
 */
export async function buscar(url, setDados, header) {
 ...
 * @param {Object} header - Cabeçalhos adicionais para autenticação ou configurações da requisição.
 */
export async function cadastrar(url, dados, setDados, header) {
 ...
 * @param {Object} header - Cabeçalhos adicionais para autenticação ou configurações da requisição.
 */
export async function atualizar(url, dados, setDados, header) {
 ...
 * @param {Object} header - Cabeçalhos adicionais para autenticação ou configurações da requisição.
 */
export async function deletar(url, header) {
  await api.delete(url, header); // Envia uma requisição DELETE para o servidor.
}

// jogos
export async function registrarJogo(url, dados, setDados, header) {
